...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[Api].[ContaminationReportCleaned]') AND type in (N'P', N'PC'))
	DROP PROCEDURE [Api].[ContaminationReportCleaned]
GO
...
--               cleaned between two dates
--               
--              

-- =============================================
CREATE PROCEDURE [Api].[ContaminationReportCleaned]
