...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[Api].[ContaminationReportNew]') AND type in (N'P', N'PC'))
	DROP PROCEDURE [Api].[ContaminationReportNew]
GO
...
--               added between two dates
--               
--              

-- =============================================
CREATE PROCEDURE [Api].[ContaminationReportNew]
