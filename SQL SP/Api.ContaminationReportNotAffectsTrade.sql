...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[Api].[ContaminationReportNotAffectsTrade]') AND type in (N'P', N'PC'))
	DROP PROCEDURE [Api].[ContaminationReportNotAffectsTrade]
GO
...
-- =============================================
CREATE PROCEDURE [Api].[ContaminationReportNotAffectsTrade]
