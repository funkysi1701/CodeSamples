...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[Api].[ContaminationReportAction4]') AND type in (N'P', N'PC'))
	DROP PROCEDURE [Api].[ContaminationReportAction4]
GO
...
-- =============================================
CREATE PROCEDURE [Api].[ContaminationReportAction4]
