...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[Api].[ContaminationReportAction3]') AND type in (N'P', N'PC'))
	DROP PROCEDURE [Api].[ContaminationReportAction3]
GO
...
-- =============================================
CREATE PROCEDURE [Api].[ContaminationReportAction3]
