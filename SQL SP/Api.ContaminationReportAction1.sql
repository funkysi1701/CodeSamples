...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[Api].[ContaminationReportAction1]') AND type in (N'P', N'PC'))
	DROP PROCEDURE [Api].[ContaminationReportAction1]
GO
...
-- =============================================
CREATE PROCEDURE [Api].[ContaminationReportAction1]
